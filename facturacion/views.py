...
def FacturarCuenta(request):
    ...
    if (ingresoId.serviciosIng_id == servicioAmb.id) :
       ...
       miConexion3 = psycopg2.connect(host="192.168.79.129", database="vulner", port="5432", user="postgres",  password="pass123")
       cur3 = miConexion3.cursor()
       comando = 'UPDATE admisiones_ingresos SET "serviciosIng_id" = "serviciosActual_id", "dxSalida_id"= "dxActual_id", "medicoSalida_id" = "medicoActual_id",  "serviciosSalida_id" = "servicioActual_id"  WHERE id =  ' + ingresoId.id
       print(comando)
       cur3.execute(comando)
       miConexion3.commit()
       miConexion3.close()
